...
VALUES
  (
    ...
    'live',
    'template',
    'https://bemgnttmaqpmsaosdisc.supabase.co/storage/v1/object/public/product-images/writers-sanctuary/cover-photo.jpg',
    ...
    ARRAY['https://bemgnttmaqpmsaosdisc.supabase.co/storage/v1/object/public/product-images/writers-sanctuary/cover-photo.jpg']
  ),
  (
    'creators-studio',
    'Creator''s Studio',
    ...
    'live',
    'template',
    'https://bemgnttmaqpmsaosdisc.supabase.co/storage/v1/object/public/product-images/creators-studio/cover-photo.jpg',
    ...
    '[{"question":"Do I need a Notion account?","answer":"Yes — a free Notion account is all you need."},{"question":"How do I access the template after purchase?","answer":"You''ll receive a Quick-Start PDF guide and a direct link to duplicate the template into your workspace."},{"question":"Is this a one-time purchase?","answer":"Yes. One payment, lifetime access. Free updates included."},{"question":"Can I get a refund?","answer":"Yes — 30-day satisfaction guarantee. Reach out to hello@creativelynanda.co.za."}]'::jsonb,
    ARRAY['https://bemgnttmaqpmsaosdisc.supabase.co/storage/v1/object/public/product-images/creators-studio/cover-photo.jpg']
  ),
  (
    ...
    'live',
    'template',
    'https://bemgnttmaqpmsaosdisc.supabase.co/storage/v1/object/public/product-images/music-artist/cover-photo.jpg',
    ...
    '[{"question":"Do I need a Notion account?","answer":"Yes — a free Notion account is all you need."},{"question":"How do I access the template after purchase?","answer":"You''ll receive a Quick-Start PDF guide and a direct link to duplicate the template into your workspace."},{"question":"Is this a one-time purchase?","answer":"Yes. One payment, lifetime access. Free updates included."},{"question":"Can I get a refund?","answer":"Yes — 30-day satisfaction guarantee. Reach out to hello@creativelynanda.co.za."}]'::jsonb,
    ARRAY['https://bemgnttmaqpmsaosdisc.supabase.co/storage/v1/object/public/product-images/music-artist/cover-photo.jpg']
  ),
  (
    ...
    'live',
    'template',
    'https://bemgnttmaqpmsaosdisc.supabase.co/storage/v1/object/public/product-images/high-school/cover-photo.jpg',
    ...
    '[{"question":"Do I need a Notion account?","answer":"Yes — a free Notion account is all you need."},{"question":"How do I access the template after purchase?","answer":"You''ll receive a Quick-Start PDF guide and a direct link to duplicate the template into your workspace."},{"question":"Is this a one-time purchase?","answer":"Yes. One payment, lifetime access. Free updates included."},{"question":"Can I get a refund?","answer":"Yes — 30-day satisfaction guarantee. Reach out to hello@creativelynanda.co.za."}]'::jsonb,
    ARRAY['https://bemgnttmaqpmsaosdisc.supabase.co/storage/v1/object/public/product-images/high-school/cover-photo.jpg']
  ),
  (
    ...
    'live',
    'template',
    'https://bemgnttmaqpmsaosdisc.supabase.co/storage/v1/object/public/product-images/varsity/cover-photo.jpg',
    ...
    '[{"question":"Do I need a Notion account?","answer":"Yes — a free Notion account is all you need."},{"question":"How do I access the template after purchase?","answer":"You''ll receive a Quick-Start PDF guide and a direct link to duplicate the template into your workspace."},{"question":"Is this a one-time purchase?","answer":"Yes. One payment, lifetime access. Free updates included."},{"question":"Can I get a refund?","answer":"Yes — 30-day satisfaction guarantee. Reach out to hello@creativelynanda.co.za."}]'::jsonb,
    ARRAY['https://bemgnttmaqpmsaosdisc.supabase.co/storage/v1/object/public/product-images/varsity/cover-photo.jpg']
  ),
  (
    'sme-command-center',
    'SME Command Center',
    ...
    'live',
    'template',
    'https://bemgnttmaqpmsaosdisc.supabase.co/storage/v1/object/public/product-images/sme/cover-photo.jpg',
    ...
    '[{"question":"Do I need a Notion account?","answer":"Yes — a free Notion account is all you need."},{"question":"How do I access the template after purchase?","answer":"You''ll receive a Quick-Start PDF guide and a direct link to duplicate the template into your workspace."},{"question":"Is this a one-time purchase?","answer":"Yes. One payment, lifetime access. Free updates included."},{"question":"Can I get a refund?","answer":"Yes — 30-day satisfaction guarantee. Reach out to hello@creativelynanda.co.za."}]'::jsonb,
    ARRAY['https://bemgnttmaqpmsaosdisc.supabase.co/storage/v1/object/public/product-images/sme/cover-photo.jpg']
  )
