...
import {
  ...
  MessageSquare, ArrowLeft, Save, Loader2, AlertCircle, CheckCircle, Plus, X,
} from 'lucide-react';
...
export default function EditBlogPostPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      setTags(data.tags || []);
      setReadingTime(data.reading_time ? String(data.reading_time) : '');
        ...
        <main className="flex-1 p-8">
          <div className="max-w-3xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h1 className="text-3xl font-display font-bold text-navy">Edit Blog Post</h1>
                <p className="text-navy/60">Update your article content and settings</p>
              </div>
            </div>
            ...
            {loading && (
              <div className="bg-white rounded-xl p-12 text-center shadow-sm border border-navy/10">
                ...
                <p className="text-navy/60">Loading post...</p>
              </div>
            )}
