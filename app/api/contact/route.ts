        ...
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; color: #0A1128;">
          ...
          <div style="background: #F5EFE6; padding: 32px; border-radius: 0 0 16px 16px; border: 1px solid #E8DCC4;">
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
              <tr><td style="padding: 8px 0; color: #C1292E; font-size: 12px; font-weight: bold; text-transform: uppercase; letter-spacing: 0.1em; width: 100px;">Name</td><td style="padding: 8px 0; color: #0A1128; font-weight: 600;">${name}</td></tr>
              <tr><td style="padding: 8px 0; color: #C1292E; font-size: 12px; font-weight: bold; text-transform: uppercase; letter-spacing: 0.1em;">Email</td><td style="padding: 8px 0;"><a href="mailto:${email}" style="color: #0A1128;">${email}</a></td></tr>
              <tr><td style="padding: 8px 0; color: #C1292E; font-size: 12px; font-weight: bold; text-transform: uppercase; letter-spacing: 0.1em;">Subject</td><td style="padding: 8px 0; color: #0A1128;">${subject || 'Not specified'}</td></tr>
            </table>
            <div style="background: white; border-radius: 12px; padding: 24px; border-left: 4px solid #C1292E;">
              ...
              <p style="color: #0A1128; line-height: 1.8; margin: 0; white-space: pre-wrap;">${message}</p>
            </div>
            <p style="color: #0A1128; opacity: 0.4; font-size: 12px; margin-top: 24px; text-align: center;">Hit reply to respond directly to ${name}</p>
          </div>
        </div>
      `,
    });
      ...
      html: `
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; color: #0A1128;">
          <div style="background: linear-gradient(135deg, #0A1128, #1a2744); padding: 32px; border-radius: 16px 16px 0 0; text-align: center;">
            <h1 style="color: #E8DCC4; font-size: 28px; margin: 0;">Thank you, ${name.split(' ')[0]}!</h1>
