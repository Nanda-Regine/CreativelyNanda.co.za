...
This is built for the African literary context. SA and African publishing houses, competitions open to African writers, self-publishing pathways for the continent. A one-line pitch formula. Rejection recovery protocol. Quarterly and annual audits of your output and submissions. This is the system that turns a scattered writing life into a serious creative career.`,
    features: [
      {
        title: 'Writing Projects — From Spark to Publication',
        description: "Track every piece of writing across its full lifecycle — concept, drafting, editing, submission, and publication. Word count goals, deadline tracking, publication targets, and rights status in one view. Nothing falls between the cracks again.",
        icon: 'book-open',
      },
      {
        title: 'Writing Sessions Log — Your Creative Training Record',
        description: 'Every session logged with word count, duration, mood rating, and momentum notes. Over time this builds a data picture of your creative patterns — when you write best, what conditions produce your best work, and how your practice is growing.',
        icon: 'pen-tool',
      },
      {
        title: "Idea Vault — A Creative Reservoir That Never Leaks",
        description: 'A structured capture system for every idea, image, fragment, and observation. Organised by genre, theme, and development status — from raw spark to developed pitch ready for the submission pipeline. Built so capture takes seconds.',
        icon: 'lightbulb',
      },
      {
        title: 'Submission Tracker — Your Full Publishing Pipeline',
        description: 'End-to-end management of your submission life. Every journal, competition, agent, and anthology submission tracked with deadlines, response timelines, follow-up triggers, and outcome records. Includes rights management and a rejection recovery protocol.',
        icon: 'send',
      },
      {
        title: 'Reading List & Research — Connect What You Read to What You Write',
        description: 'A literary education database that links every book, essay, and research source directly to your active writing projects. Craft insights captured where they can actually improve your work — not lost in a separate reading app.',
        icon: 'library',
      },
      {
        title: 'Writing Habits — Practice Infrastructure That Sustains the Work',
        description: 'Weekly habit tracking anchored by craft intentions and creative affirmations. Streak tracking, session goals, and a quarterly audit of your writing output and submission pipeline. The system that turns one good writing week into a consistent creative practice.',
        icon: 'zap',
      },
    ],
    faqs: [
...
Built specifically for Africa's creator economy — with content pillar frameworks, hook-writing systems, brand deal negotiation protocols, South African tax compliance guidance, and monthly business review checklists. Because building a content business in Africa requires infrastructure that understands the market you're actually operating in.`,
    features: [
      {
        title: 'Content Projects Calendar — Every Piece, Every Platform',
        description: "Your live content command center. Every piece from concept to published, across Instagram, TikTok, YouTube, LinkedIn, and beyond — with status, caption drafts, linked assets, publishing dates, and performance notes. Never wonder what you're supposed to be posting again.",
        icon: 'layout',
      },
      {
        title: 'Brand Partnerships — Full Deal Lifecycle Management',
        description: "From first inquiry to final payment. Rate card management, contract status tracking, deliverable deadlines, revision rounds, payment follow-ups, and post-campaign reporting — all in one system. Built so no deal detail ever falls through the cracks.",
        icon: 'briefcase',
      },
      {
        title: 'Content Batch Tracker — Your Production Command Center',
        description: 'Plan and log every batch day with filming checklists, editing queues, asset completion tracking, and output records. Build a production history that helps you plan smarter batches and cut your content production time every month.',
        icon: 'film',
      },
      {
        title: 'Idea Bank — Never Lose a Content Idea Again',
        description: "A creative reservoir for every concept, hook, series idea, trend observation, and content angle you encounter. Developed into full briefs when it's time to produce. Your Idea Bank becomes the strategic resource that fuels your entire content pipeline.",
        icon: 'lightbulb',
      },
      {
        title: "Analytics Tracker — Data That Actually Changes Your Strategy",
        description: "Monthly performance records across every platform you're active on. Track reach, engagement, follower growth, and top-performing content over time. Stop making content decisions based on gut feel and start building a strategy grounded in your actual data.",
        icon: 'bar-chart',
      },
      {
        title: 'Creative Habits — Sustainable Output Infrastructure',
        description: 'Daily and weekly habit tracking for the creative practices that keep your business running: content planning sessions, engagement blocks, skill development, and creative recovery. Built with a monthly business review template that keeps you growing quarter on quarter.',
        icon: 'zap',
      },
    ],
    faqs: [
    ...
    features: [
      {
        ...
        description: "Unlike any other music template, this system ships with real South African music industry data already inside. 10 interconnected databases filled with contacts, deadlines, specs, and intelligence — so you can start using the system immediately, not after months of research.",
        icon: 'database',
      },
      {
        title: 'SA Radio & Press — 40 Pre-Loaded Contacts',
        description: '20 South African radio stations with submission contacts, format specs, and playlist information. 20 SA and pan-African music press outlets and blogs with editorial context. The relationship infrastructure most independent artists never fully build.',
        icon: 'radio',
      },
      {
        title: 'Grants & Funding — Pre-Loaded Opportunities',
        description: "South African and pan-African music funding opportunities with eligibility criteria, amounts, application windows, and deadlines already entered. Know what's available, when to apply, and what you need to qualify — before the window closes.",
        icon: 'dollar-sign',
      },
      {
        title: 'Festivals, Venues & Industry Calendar',
        description: '18 SA music festivals with booking contacts and application deadlines. SA music venues with capacity and fee ranges. A month-by-month industry calendar that maps release windows, award cycles, festival seasons, and grant periods across the full year.',
        icon: 'calendar',
      },
      {
        title: 'Streaming & Distribution Intelligence',
        description: '18 target playlists across Spotify, Apple Music, and YouTube for pitching your releases. DSP technical specifications and royalty rate structures for every major platform. Professional audio delivery standards for international release quality. Everything you need to release professionally.',
        icon: 'play-circle',
      },
      {
        title: 'Release Timeline & Career Management',
        description: 'A complete release timeline framework from mastering to launch. SAMRO registration guidance. Grant application strategy. Press outreach workflow. Tour planning system. The full career management infrastructure that turns music-making into music business.',
        icon: 'music',
      },
    ],
    faqs: [
...
My Subjects gives you a full academic profile for each subject — current marks, target marks, teacher details, required study hours, and a realistic picture of where you stand and what it will take to reach your targets. Assignments & Tasks tracks your complete academic workload with priority logic across all seven subjects so nothing gets missed and nothing gets submitted late. Study Sessions builds a real training log — every session recorded with subject, duration, topics, and a honest assessment of productivity, so you can see your patterns and work with them. Exam Prep Tracker manages end-to-end exam preparation: past papers completed, topics mastered, weak areas identified and targeted, and exam day planning done properly. Term Goals & Progress sets strategic targets at the beginning of every term and tracks them weekly — so you make adjustments before results day, not after. Wellness Check-Ins gives your mental health and stress levels a proper place in the system, because managing your wellbeing is part of managing your academic performance. And the Weekly Detailed Schedule uses time-blocking to give every hour of your week a purpose — with room built in for the rest that makes study effective.`,
    features: [
      {
        title: 'My Subjects — Your Academic Command Centre',
        description: 'A full academic profile for each of your subjects — current marks, target marks, teacher details, required weekly study hours, and realistic gap analysis. Know exactly where you stand in every subject and what it will take to close the gap before your next exam.',
        icon: 'book',
      },
      {
        title: 'Assignments & Tasks — Zero Missed Deadlines',
        description: "Your complete academic workload in one place. Every assignment, test, project, and practical logged with due dates, marks, submission status, and priority tier across all seven subjects. The system that makes 'I forgot' impossible.",
        icon: 'check-square',
      },
      {
        title: 'Exam Prep Tracker — Past Papers & Weak Area Targeting',
        description: 'Structured exam preparation built around the most effective matric study method: past papers. Track papers completed per subject, topics fully mastered, weak areas flagged for focused revision, and mark your exam day preparation done — not panicked.',
        icon: 'target',
      },
      {
        title: 'Study Sessions — Your Training Log',
        description: 'Every study session logged with subject, duration, topics covered, and an honest productivity rating. Over a term, this builds a real data picture of your study patterns — when you work best, which subjects take most energy, and how your preparation is actually progressing.',
        icon: 'clock',
      },
      {
        title: 'Wellness Check-Ins — Because Matric Pressure Is Real',
        description: 'A built-in mental health and stress tracking system that treats your wellbeing as part of your academic strategy. Weekly check-ins tracking stress levels, sleep quality, mood, and energy — so you can spot burnout early and make adjustments before it costs you marks.',
        icon: 'heart',
      },
      {
        title: 'Term Goals & Weekly Schedule',
        description: 'Strategic goal-setting at the start of every term with weekly progress checks that let you course-correct before results day. Paired with a time-blocking weekly schedule that gives every hour a purpose and builds sustainable study habits across the full academic year.',
        icon: 'trending-up',
      },
    ],
    faqs: [
...
Built for the reality of South African university life — managing multiple modules, financial pressure, part-time work, and the transition from the structured pace of high school to entirely self-directed study. Quarterly reviews and annual performance audits built into the system.`,
    features: [
      {
        title: 'My Subjects — Full Module Registry',
        description: "Every module tracked with current marks, target marks, credit loads, difficulty ratings, lecturer details, and office hours. A real-time picture of your full academic standing across your entire degree — not just the modules you're worried about.",
        icon: 'book',
      },
      {
        title: 'Assignments & Tasks — Multi-Module Deadline Management',
        description: "Every assessment, deadline, submission portal, group work contribution, and mark weight across all your modules in one system. Priority logic that surfaces what actually needs your attention today — not everything at once.",
        icon: 'check-square',
      },
      {
        title: "Exam Prep Tracker — Systematic, Not Desperate",
        description: "Structured exam preparation built around evidence: past papers completed per module, topics you've mastered, weak areas identified and targeted, and study time allocated strategically based on mark weight and difficulty. The system that turns 'I think I'm ready' into 'I know I'm ready'.",
        icon: 'target',
      },
      {
        title: 'Study Sessions — Revision History & Pattern Recognition',
        description: "Every study session logged with module, method, duration, topics covered, and a productivity rating. Over a semester, this builds a data picture of when you study best, which methods work for which subjects, and how your preparation is actually progressing against your exam timeline.",
        icon: 'clock',
      },
      {
        title: 'Wellness Check-Ins — Performance Starts With Wellbeing',
        description: 'Weekly tracking of sleep quality, stress levels, motivation, social connection, and overall energy. Built into the academic system because university burnout is a performance issue as much as a health one — and catching it early changes outcomes.',
        icon: 'heart',
      },
      {
        title: 'Term Goals & Weekly Schedule',
        description: 'Goal-setting across academic, career, wellness, and personal dimensions aligned to your quarterly rhythm. Paired with time-blocking that builds a realistic weekly schedule accommodating lectures, study, part-time work, and recovery. Quarterly reviews and annual audits built in.',
        icon: 'trending-up',
      },
    ],
    faqs: [
...
Built for South African business reality — with SARS compliance guidance, VAT record-keeping structure, CIPC documentation support, BBBEE score tracking, a monthly financial review template, and a financial dashboard that gives you a clear view of your business health at any point in time.`,
    features: [
      {
        title: 'Clients Hub — Your Full Business CRM',
        description: "Every client relationship managed from first contact to completed project and beyond. Contact details, contract values, project history, payment status, follow-up reminders, and prospect pipeline — all in one database. The client system that makes you look like a business, not a freelancer.",
        icon: 'users',
      },
      {
        title: 'Projects Tracker — Full Operational Visibility',
        description: "Every project tracked from brief to payment with status, deadlines, linked tasks, assigned team members, client reference, and revenue attached. Real-time visibility across your entire project portfolio — so you always know what's in progress, what's at risk, and what's being invoiced.",
        icon: 'git-branch',
      },
      {
        title: 'Revenue & Expenses — Built for SARS Compliance',
        description: 'Complete income records linked to clients and projects. Complete expenditure records structured for South African SARS tax deduction documentation. Monthly financial review template. A financial dashboard that gives you a real-time picture of your business performance — and records that survive an audit.',
        icon: 'trending-up',
      },
      {
        title: 'Tasks Command Center — Nothing Lost in WhatsApp',
        description: 'Every work action captured with owner, deadline, priority level, and project link. Tasks assigned, tracked, and completed inside the same system where your projects and clients live. The system that replaces the chaos of work managed through messages, email chains, and memory.',
        icon: 'check-square',
      },
      {
        title: 'Team Directory & Inventory Manager',
        description: 'Your full people database — employees, freelancers, and contractors with roles, contacts, rates, and accountability. Paired with an inventory manager for stock, equipment, and materials linked to project costing. The operational infrastructure that makes managing a team and physical assets less chaotic.',
        icon: 'package',
      },
      {
        title: 'Documents Library — One Home for Everything',
        description: "Contracts, proposals, quotes, NDAs, business registration documents, compliance records — all centrally stored with version control and category organisation. The system that ends 'I can't find the original contract' and ensures your business documentation is always where you need it.",
        icon: 'folder',
      },
    ],
    faqs: [
...
export const ALL_PRODUCTS: ProductCoverData[] = [
  {
    ...
    badge: 'BESTSELLER',
    status: 'live',
    thumbnail: `${PROD_IMG}/writers-sanctuary/cover.png`,
    impact: 'Built for 500K+ aspiring African writers',
    topFeatures: ['Writing Projects', 'Submission Tracker', 'Idea Vault'],
  },
  {
    ...
    badge: 'NEW',
    status: 'live',
    thumbnail: `${PROD_IMG}/creators-studio/cover.png`,
    impact: "Designed for Africa's 2M+ content creators",
    topFeatures: ['Content Projects', 'Brand Partnerships', 'Analytics Tracker'],
  },
  {
    ...
    category: 'Creative',
    status: 'live',
    thumbnail: `${PROD_IMG}/music-artist/cover.png`,
    impact: 'Built for 50K+ independent South African artists',
    topFeatures: ['SA Radio Stations', 'Grants & Funding', 'Music Industry Calendar'],
  },
  {
    ...
    category: 'Student',
    status: 'live',
    thumbnail: `${PROD_IMG}/high-school/cover.png`,
    impact: 'Serving 500K+ matric students nationwide',
    topFeatures: ['Assignments & Tasks', 'Exam Prep Tracker', 'Wellness Check-ins'],
  },
  {
    ...
    category: 'Student',
    status: 'live',
    thumbnail: `${PROD_IMG}/varsity/cover.png`,
    impact: 'Built for 1M+ South African university students',
    topFeatures: ['Assignments & Tasks', 'Exam Prep Tracker', 'Wellness Check-ins'],
  },
  {
    ...
    badge: 'POPULAR',
    status: 'live',
    thumbnail: `${PROD_IMG}/sme/cover.png`,
    impact: 'Designed for 2M+ African entrepreneurs and SMEs',
    topFeatures: ['Clients Hub', 'Revenue Tracker', 'Projects Tracker'],
  },
];
